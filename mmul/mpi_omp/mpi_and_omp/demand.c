...
int main(int argc, char *argv[]) {
    ...
    // "S is the number of rows each OpenMP process will compute"
    ...
    if(rank == 0)
        printf("(d_omp_mpi) Execution time for A[%d][%d] x B[%d][%d] = C[%d][%d], using %d MPI processes and %d OpenMP threads per process is %.6lf\n",
